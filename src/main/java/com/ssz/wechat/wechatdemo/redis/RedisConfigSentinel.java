package com.ssz.wechat.wechatdemo.redis;
...
public class RedisConfigSentinel {
    ...
    @Value("${redis.senHost1}")
    private String senHost1;

    @Value("${redis.senPort1}")
    ...
    /**
     * 配置redis的哨兵 @return RedisSentinelConfiguration @autor lpl @date
     * 2017年12月21日 @throws
     */
    @Bean
...
//	/**
//	 * 封装RedisTemplate @Title: redisUtil @return RedisUtil @autor lpl @date
//	 * 2017年12月21日 @throws
//	 */
//	@Bean(name = "redisUtil")
